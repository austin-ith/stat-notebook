...
$$Comment: The wilcox Test does not like ties very much because it is a discrete test. Always check for ties when given the warning.

We are now testing "Median's"

"True location shift is not equal to 0" means that we support the null hypothesis$$
