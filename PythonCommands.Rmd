...
|--------------------|--------|
| Equals (one value) | `columnName` `==` `value` |
| Equals Any Of (several values) | `columnName` `%in%` `c(value1,value2,...)` |
| Not Equal (one value)| `columnName` `!=` `value` |
| Not Equals Any of (several values) | `!columnName` `%in%` `c(value1,value2,...)` |
